...
- Copy and paste this code in consule making sure you write the name of your website
...
Add this code in the console and click ENTER:  
...
- Click on index.rmd from the Files tab (bottom right pane)

- Now go to top left pane.
...
- Now add all your info on your homepage
...
- Save all the images you want to use in the folder
...
- Undere the Files tab in the bottom right pane select 'index.rmd'.

- In the Source Editor (top left pane) you can see "image:"

- Change image by writing down the name of folde/name of image.format of image. ( in between the speech marks)
...
- Write the title  of this page in the top left window
